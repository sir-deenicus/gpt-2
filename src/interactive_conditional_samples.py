...
def interact_model(
    ...
    with tf.Session(graph=tf.Graph()) as sess:
        ...
        queries = [	
                    ...
                    'Mary is the head of a research lab and John is a secetary discussing next week\'s schedule. Mary wants a new laser ordered but due to issues with their supplier, John says this might not be possible because', 
                    'P(A|B) =',
